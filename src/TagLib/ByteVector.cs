...
namespace TagLib
{
   ...
   public class ByteVector : IList
   {
      ...
      int  IList.Add (object value) {return Add ((byte)value);}
      public int Add (byte value)   {return data.Add (value);}
      
      public void Clear () {data.Clear ();}
      
      bool  IList.Contains (object value)  {return Contains ((byte) value);}
      public bool Contains (byte value) {return IndexOf (value) != -1;}
      
      int  IList.IndexOf (object value) {return IndexOf ((byte)value);}
      public int IndexOf (byte value)   {return data.IndexOf (value);}
      
      void  IList.Insert (int index, object value) {Insert (index, (byte)value);}
      public void Insert (int index, byte value)   {data.Insert (index, value);}
      
      void  IList.Remove (object value) {Remove ((byte)value);}
      public void Remove (byte value)   {data.Remove (value);}
      ...
      public ByteVector (ByteVector v)
      {
         Add (v);
      }
      ...
      public byte [] Data
      {
         get {return (byte []) data.ToArray (typeof (System.Byte));}
      }
      ...
      public bool ContainsAt (ByteVector pattern, int offset, int pattern_offset, int pattern_length)
      {
         ...
         if(pattern_length > Count || offset >= Count || pattern_offset >= pattern.Count || pattern_length == 0)
            return false;
      ...
      public uint ToUInt (bool most_significant_byte_first)
      {
         // FIXME: Generics would be nice if I could figure them out.
         //return ToNumber<uint>(Data, most_significant_byte_first);
         uint sum = 0;
         ...
         for (int i = 0; i <= last; i ++)
            sum |= (uint) this [i] << ((most_significant_byte_first ? last - i : i) * 8);
      ...
      public short ToShort (bool most_significant_byte_first)
      {
         // FIXME: Generics would be nice if I could figure them out.
         ...
         for (int i = 0; i <= last; i ++)
            sum |= (short) (this [i] << ((most_significant_byte_first ? last - i : i) * 8));
      ...
      public long ToLong (bool most_significant_byte_first)
      {
         // FIXME: Generics would be nice if I could figure them out.
         ...
         for (int i = 0; i <= last; i ++)
            sum |= (long) this [i] << ((most_significant_byte_first ? last - i : i) * 8);
      ...
      public static ByteVector FromUInt (uint value, bool most_significant_byte_first)
      {
         // FIXME: Generics would be nice if I could figure them out.
         ...
         for (int i = 0; i < 4; i++)
            v.Add ((byte) (value >> ((most_significant_byte_first ? 3 - i : i) * 8) & 0xFF));
      ...
      public static ByteVector FromShort (short value, bool most_significant_byte_first)
      {
         // FIXME: Generics would be nice if I could figure them out.
         ...
         for (int i = 0; i < 2; i++)
            v.Add ((byte) (value >> ((most_significant_byte_first ? 1 - i : i) * 8) & 0xFF));
      ...
      public static ByteVector FromLong (long value, bool most_significant_byte_first)
      {
         // FIXME: Generics would be nice if I could figure them out.
         ...
         for (int i = 0; i < 8; i++)
            v.Add ((byte) (value >> ((most_significant_byte_first ? 7 - i : i) * 8) & 0xFF));
      ...
      private static T ToNumber<T>(byte [] data, bool most_significant_byte_first) where T : IConvertible
      {
         ...
         for (int i = 0; i <= last; i ++)
            sum |= (T) data [i] << ((most_significant_byte_first ? last - i : i) * 8);
      ...
      private static ByteVector FromNumber<T> (T value, bool most_significant_byte_first)
      {
         ...
         for (int i = 0; i < size; i++)
            v.Add ((byte) (value >> ((most_significant_byte_first ? size - 1 - i : i) * 8) & 0xFF));
