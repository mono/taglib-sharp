...
namespace TaglibSharp.Tests.FileFormats
{
	...
	public class M4aFormatTest : IFormatTest
	{
		...
		public void bgo_676934 ()
		{
			...
			ClassicAssert.IsTrue (file.CorruptionReasons.Any (), "#1");
		}
		...
		public void bgo_701689 ()
		{
			...
			ClassicAssert.AreEqual ("883821fc-9bbc-4e04-be79-b4b12c4c4a4e", file.Tag.MusicBrainzRecordingId, "#1");
		}
		...
		public void ReadAppleAacTags ()
		{
			...
			ClassicAssert.AreEqual (2, file.UdtaBoxes.Count, "#1");

			var first = file.UdtaBoxes[0];
			ClassicAssert.AreEqual (1, first.Children.Count (), "#2");

			ClassicAssert.IsInstanceOf<AppleAdditionalInfoBox> (first.Children.First ());
			var child = (AppleAdditionalInfoBox)first.Children.First ();
			ClassicAssert.AreEqual ((ReadOnlyByteVector)"name", child.BoxType, "#3");
			ClassicAssert.AreEqual (0, child.Data.Count, "#4");
		}
		...
		{
			ClassicAssert.AreEqual ("M4A album", file.Tag.Album);
			ClassicAssert.AreEqual ("M4A artist", file.Tag.FirstPerformer);
			ClassicAssert.AreEqual ("M4A comment", file.Tag.Comment);
			ClassicAssert.AreEqual ("Acid Punk", file.Tag.FirstGenre);
			ClassicAssert.AreEqual ("M4A title", file.Tag.Title);
		...
		public void ReadReplayGain()
		{
			...
			ClassicAssert.AreEqual(-1.43, fileWithRg.Tag.ReplayGainTrackGain, 0.01);
		}
