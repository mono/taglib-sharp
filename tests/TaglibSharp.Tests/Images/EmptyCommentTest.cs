	...
	public class EmptyCommentTestInvariantValidator : IMetadataInvariantValidator
	{
		public void ValidateMetadataInvariants (TagLib.Image.File file)
		{
			...
			// Image.0x010E (ImageDescription/Ascii/32) "OLYMPUS DIGITAL CAMERA         "
			{
				...
				ClassicAssert.AreEqual ("OLYMPUS DIGITAL CAMERA         ", (entry as StringIFDEntry).Value);
			}
			// Image.0x010F (Make/Ascii/24) "OLYMPUS OPTICAL CO.,LTD"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("OLYMPUS OPTICAL CO.,LTD", (entry as StringIFDEntry).Value);
			}
			// Image.0x0110 (Model/Ascii/13) "E-10        "
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("E-10        ", (entry as StringIFDEntry).Value);
			}
			...
			// Image.0x011A (XResolution/Rational/1) "144/1"
			{
				...
				ClassicAssert.AreEqual (144, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Image.0x0131 (Software/Ascii/32) "42-0119                        "
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("42-0119                        ", (entry as StringIFDEntry).Value);
			}
			// Image.0x0132 (DateTime/Ascii/20) "2005:06:01 12:21:45"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2005:06:01 12:21:45", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x829D (FNumber/Rational/1) "36/10"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (36, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Photo.0x8827 (ISOSpeedRatings/Short/1) "80"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (80, (entry as ShortIFDEntry).Value);
			}
			...
			// Photo.0x9205 (MaxApertureValue/Rational/1) "206/100"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (206, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Photo.0x920A (FocalLength/Rational/1) "170/10"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (170, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (10, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Olympus.0x0200 (SpecialMode/Long/3) "3631961967 3583981211 265841571"
			{
				...
				ClassicAssert.AreEqual (new long[] { 3631961967, 3583981211, 265841571 }, (entry as LongArrayIFDEntry).Values);
			}
			...
			// Olympus.0x0203 (BWMode/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x0203 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x0204 (DigitalZoom/Rational/1) "149128747/4155087494"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x0204 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (149128747, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (4155087494, (entry as RationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x0205 (FocalPlaneDiagonal/Rational/1) "2670046643/2671390721"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (2670046643, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (2671390721, (entry as RationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x0206 (LensDistortionParams/SShort/6) "-5164 6906 7757 835 -25578 -17709"
			{
				...
				ClassicAssert.AreEqual (new short[] { -5164, 6906, 7757, 835, -25578, -17709 }, (entry as SShortArrayIFDEntry).Values);
			}
			...
			// Olympus.0x1000 (ShutterSpeed/SRational/1) "764354177/-942049472"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1000 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (764354177, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (-942049472, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1001 (ISOSpeed/SRational/1) "1239879654/638047914"
			{
				...
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (1239879654, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (638047914, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1002 (ApertureValue/SRational/1) "-1765853430/1703491222"
			{
				...
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (-1765853430, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (1703491222, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1003 (Brightness/SRational/1) "-816914756/1974393359"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1003 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (-816914756, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (1974393359, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1004 (FlashMode/Short/1) "3"
			{
				var entry = makernote_structure.GetEntry (0, (ushort)OlympusMakerNoteEntryTag.FlashMode);
				ClassicAssert.IsNotNull (entry, "Entry 0x1004 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
			...
			// Olympus.0x1005 (FlashDevice/Short/2) "0 0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1005 missing in IFD 0");
			...
			// Olympus.0x1006 (Bracket/SRational/1) "335386020/1890807289"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1006 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (335386020, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (1890807289, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1007 (SensorTemperature/SShort/1) "23"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1007 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SShortIFDEntry, "Entry is not a signed short!");
				ClassicAssert.AreEqual (23, (entry as SShortIFDEntry).Value);
			}
			// Olympus.0x1008 (LensTemperature/SShort/1) "22"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1008 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SShortIFDEntry, "Entry is not a signed short!");
				ClassicAssert.AreEqual (22, (entry as SShortIFDEntry).Value);
			}
			// Olympus.0x1009 (0x1009/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1009
				var entry = makernote_structure.GetEntry (0, 0x1009);
				ClassicAssert.IsNotNull (entry, "Entry 0x1009 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x100A (0x100a/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x100A missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x100B (FocusMode/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x100B missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x100C (FocusDistance/Rational/1) "1973778547/1270124588"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x100C missing in IFD 0");
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (1973778547, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (1270124588, (entry as RationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x100D (Zoom/Short/1) "12"
			{
				var entry = makernote_structure.GetEntry (0, (ushort)OlympusMakerNoteEntryTag.Zoom);
				ClassicAssert.IsNotNull (entry, "Entry 0x100D missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
			...
			// Olympus.0x100E (MacroFocus/Short/1) "315"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x100E missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (315, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x100F (SharpnessFactor/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x100F missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1010 (FlashChargeLevel/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1010 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1011 (ColorMatrix/Short/9) "12808 6873 28211 62318 6183 5428 43493 44469 45896"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1011 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 12808, 6873, 28211, 62318, 6183, 5428, 43493, 44469, 45896 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x1012 (BlackLevel/Short/4) "37164 37255 16551 9228"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1012 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 37164, 37255, 16551, 9228 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x1013 (0x1013/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1013
				var entry = makernote_structure.GetEntry (0, 0x1013);
				ClassicAssert.IsNotNull (entry, "Entry 0x1013 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1014 (0x1014/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1014 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1015 (WhiteBalance/Short/2) "1 0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1015 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 1, 0 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x1016 (0x1016/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1016
				var entry = makernote_structure.GetEntry (0, 0x1016);
				ClassicAssert.IsNotNull (entry, "Entry 0x1016 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1017 (RedBalance/Short/2) "394 64"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1017 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 394, 64 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x1018 (BlueBalance/Short/2) "406 64"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1018 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 406, 64 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x1019 (0x1019/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1019
				var entry = makernote_structure.GetEntry (0, 0x1019);
				ClassicAssert.IsNotNull (entry, "Entry 0x1019 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x101A (SerialNumber2/Ascii/32) "Fz�2�T6^c8m�)ǿ�"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x101A missing in IFD 0");
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("Fz�2�T6^c8m�)ǿ�", (entry as StringIFDEntry).Value);
			}
			// Olympus.0x101B (0x101b/Long/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x101B
				var entry = makernote_structure.GetEntry (0, 0x101B);
				ClassicAssert.IsNotNull (entry, "Entry 0x101B missing in IFD 0");
			...
			// Olympus.0x101C (0x101c/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x101C missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x101D (0x101d/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x101D missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x101E (0x101e/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x101E missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x101F (0x101f/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x101F missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x1020 (0x1020/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1020 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x1021 (0x1021/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1021 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x1022 (0x1022/Long/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1022 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (0, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x1023 (FlashBias/SRational/1) "-1152340400/689675175"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1023 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (-1152340400, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (689675175, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1024 (0x1024/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1024
				var entry = makernote_structure.GetEntry (0, 0x1024);
				ClassicAssert.IsNotNull (entry, "Entry 0x1024 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1025 (0x1025/SRational/1) "-1727258578/1939699"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1025 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as SRationalIFDEntry, "Entry is not a srational!");
				ClassicAssert.AreEqual (-1727258578, (entry as SRationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (1939699, (entry as SRationalIFDEntry).Value.Denominator);
			}
			// Olympus.0x1026 (ExternalFlashBounce/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1026 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1027 (ExternalFlashZoom/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1027 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1028 (ExternalFlashMode/Short/1) "0"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1028 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1029 (Contrast/Short/1) "1"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1029 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (1, (entry as ShortIFDEntry).Value);
			}
			...
			{
				var entry = makernote_structure.GetEntry (0, (ushort)OlympusMakerNoteEntryTag.SharpnessFactor);
				ClassicAssert.IsNotNull (entry, "Entry 0x102A missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x102B (ColorControl/Short/6) "56024 63818 42376 12 65280 14993"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x102B missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 56024, 63818, 42376, 12, 65280, 14993 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x102C (ValidBits/Short/2) "10 0"
			{
				var entry = makernote_structure.GetEntry (0, (ushort)OlympusMakerNoteEntryTag.ValidBits);
				ClassicAssert.IsNotNull (entry, "Entry 0x102C missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 10, 0 }, (entry as ShortArrayIFDEntry).Values);
			}
			// Olympus.0x102D (CoringFilter/Short/1) "1792"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x102D missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (1792, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x102E (ImageWidth/Long/1) "2240"
			{
				var entry = makernote_structure.GetEntry (0, (ushort)OlympusMakerNoteEntryTag.ImageWidth);
				ClassicAssert.IsNotNull (entry, "Entry 0x102E missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (2240, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x102F (ImageHeight/Long/1) "1680"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x102F missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (1680, (entry as LongIFDEntry).Value);
			}
			// Olympus.0x1030 (0x1030/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1030
				var entry = makernote_structure.GetEntry (0, 0x1030);
				ClassicAssert.IsNotNull (entry, "Entry 0x1030 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			// Olympus.0x1031 (0x1031/Long/8) "456164396 3548531428 3220502079 1524028172 379014428 2764611586 157170167 2795214894"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1031 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as LongArrayIFDEntry, "Entry is not a long array!");
				ClassicAssert.AreEqual (new long[] { 456164396, 3548531428, 3220502079, 1524028172, 379014428, 2764611586, 157170167, 2795214894 }, (entry as LongArrayIFDEntry).Values);
			}
			// Olympus.0x1032 (0x1032/Short/1) "0"
			{
				// TODO: Unknown IFD tag: Olympus / 0x1032
				var entry = makernote_structure.GetEntry (0, 0x1032);
				ClassicAssert.IsNotNull (entry, "Entry 0x1032 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (0, (entry as ShortIFDEntry).Value);
			}
			...
			// Olympus.0x1034 (CompressionRatio/Rational/1) "3531718916/243211988"
			{
				...
				ClassicAssert.IsNotNull (entry, "Entry 0x1034 missing in IFD 0");
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (3531718916, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (243211988, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0xA002 (PixelXDimension/Short/1) "2240"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (2240, (entry as ShortIFDEntry).Value);
			}
			// Photo.0xA003 (PixelYDimension/Short/1) "1680"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (1680, (entry as ShortIFDEntry).Value);
			}
			...
			// Thumbnail.0x0202 (JPEGInterchangeFormatLength/Long/1) "11447"
			{
				...
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (11447, (entry as LongIFDEntry).Value);
			}
