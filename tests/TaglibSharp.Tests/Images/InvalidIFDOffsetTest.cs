	...
	public class InvalidIFDOffsetTestInvariantValidator : IMetadataInvariantValidator
	{
		public void ValidateMetadataInvariants (TagLib.Image.File file)
		{
			...
			// Image.0x0110 (Model/Ascii/8) "DMC-TZ5"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("DMC-TZ5", (entry as StringIFDEntry).Value);
			}
			// Image.0x0131 (Software/Ascii/28) "Adobe Photoshop CS4 Windows"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("Adobe Photoshop CS4 Windows", (entry as StringIFDEntry).Value);
			}
			// Image.0x0132 (DateTime/Ascii/20) "2010:05:03 19:39:29"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2010:05:03 19:39:29", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x829A (ExposureTime/Rational/1) "10/3200"
			{
				...
				ClassicAssert.AreEqual (3200, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0x9003 (DateTimeOriginal/Ascii/20) "2009:11:06 12:42:03"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2009:11:06 12:42:03", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x920A (FocalLength/Rational/1) "470/10"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (470, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (10, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0xA002 (PixelXDimension/Long/1) "1400"
			{
				...
				ClassicAssert.AreEqual (1400, (entry as LongIFDEntry).Value);
			}
			// Photo.0xA003 (PixelYDimension/Long/1) "933"
			{
				...
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (933, (entry as LongIFDEntry).Value);
			}
			...
			// Photo.0xA405 (FocalLengthIn35mmFilm/Short/1) "280"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (280, (entry as ShortIFDEntry).Value);
			}
