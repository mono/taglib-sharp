...
namespace TaglibSharp.Tests.Images
{
	...
	public class NullOrientationInvariantValidator : IMetadataInvariantValidator
	{
		public void ValidateMetadataInvariants (TagLib.Image.File file)
		{
			...
			ClassicAssert.AreEqual (ImageOrientation.None, file.ImageTag.Orientation);
			...
			// Image.0x0110 (Model/Ascii/15) "Canon EOS 450D"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("Canon EOS 450D", (entry as StringIFDEntry).Value);
			}
			...
			// Image.0x0132 (DateTime/Ascii/20) "2010:02:08 11:37:33"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2010:02:08 11:37:33", (entry as StringIFDEntry).Value);
			}
			// Image.0x013B (Artist/Ascii/17) "Ruben Vermeersch"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("Ruben Vermeersch", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x829A (ExposureTime/Rational/1) "1/60"
			{
				...
				ClassicAssert.AreEqual (60, (entry as RationalIFDEntry).Value.Denominator);
			}
			// Photo.0x829D (FNumber/Rational/1) "32/10"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (32, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Photo.0x9003 (DateTimeOriginal/Ascii/20) "2010:02:06 10:57:22"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2010:02:06 10:57:22", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x9201 (ShutterSpeedValue/SRational/1) "5906891/1000000"
			{
				...
				ClassicAssert.AreEqual (5906891, (entry as SRationalIFDEntry).Value.Numerator);
			...
			// Photo.0x9202 (ApertureValue/Rational/1) "3356144/1000000"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (3356144, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Photo.0x9205 (MaxApertureValue/Rational/1) "2/1"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (2, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (1, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0x9291 (SubSecTimeOriginal/Ascii/3) "02"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("02", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0xA20E (FocalPlaneXResolution/Rational/1) "4272000/878"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (4272000, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (878, (entry as RationalIFDEntry).Value.Denominator);
			}
			// Photo.0xA20F (FocalPlaneYResolution/Rational/1) "2848000/584"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (2848000, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (584, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Thumbnail.0x0202 (JPEGInterchangeFormatLength/Long/1) "17036"
			{
				...
				ClassicAssert.AreEqual (17036, (entry as LongIFDEntry).Value);
			}
