	...
	public class JpegOlympusCorruptMNTestInvariantValidator : IMetadataInvariantValidator
	{
		public void ValidateMetadataInvariants (TagLib.Image.File file)
		{
			...
			// Image.0x010F (Make/Ascii/24) "OLYMPUS IMAGING CORP.  "
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("OLYMPUS IMAGING CORP.  ", (entry as StringIFDEntry).Value);
			}
			// Image.0x0110 (Model/Ascii/17) "u740,S740       "
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("u740,S740       ", (entry as StringIFDEntry).Value);
			}
			...
			// Image.0x011A (XResolution/Rational/1) "314/1"
			{
				...
				ClassicAssert.AreEqual (314, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Image.0x0131 (Software/Ascii/47) "Microsoft Windows Photo Gallery 6.0.6000.16386"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("Microsoft Windows Photo Gallery 6.0.6000.16386", (entry as StringIFDEntry).Value);
			}
			// Image.0x0132 (DateTime/Ascii/20) "2008:10:04 22:00:22"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2008:10:04 22:00:22", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x829A (ExposureTime/Rational/1) "1/50"
			{
				...
				ClassicAssert.AreEqual (50, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0x9003 (DateTimeOriginal/Ascii/20) "2008:10:04 18:33:50"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2008:10:04 18:33:50", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x9205 (MaxApertureValue/Rational/1) "344/100"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (344, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Photo.0x920A (FocalLength/Rational/1) "886/100"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (886, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (100, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0xA404 (DigitalZoomRatio/Rational/1) "100/100"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (100, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (100, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Photo.0xEA1D (0xea1d/SLong/1) "34"
			{
				...
				ClassicAssert.AreEqual (34, (entry as SLongIFDEntry).Value);
			}
			// Image.0xC4A5 (PrintImageMatching/Undefined/528) "(Value ommitted)"
			{
				...
				ClassicAssert.AreEqual ("785d55d75dffafdef5947fb2bfd6c84b", parsed_hash);
				ClassicAssert.AreEqual (528, parsed_bytes.Length);
			}
			...
			// Thumbnail.0x0202 (JPEGInterchangeFormatLength/Long/1) "5804"
			{
				...
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (5804, (entry as LongIFDEntry).Value);
			}
