...
[TestClass]
public class JpegSegmentSizeTest : TestFixtureBase
{
	static readonly string sample_file = TestPath.Samples + "sample.jpg";
	// Use only the filename part
	static readonly string tmp_filename = "tmpwrite_exceed_segment_size.jpg";
	...
	{
		var tmp = TestFileHelper.CreateTempFile(this, sample_file, tmp_filename) as File;
		CheckTags(tmp);
