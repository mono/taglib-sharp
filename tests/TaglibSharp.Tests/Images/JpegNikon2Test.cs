...
namespace TaglibSharp.Tests.Images
{
	...
	public class JpegNikon2Test
	{
		...
		public void CheckExif (File file)
		{
			...
			ClassicAssert.AreEqual ("NIKON D70s", tag.Model);
			ClassicAssert.AreEqual (null, tag.ISOSpeedRatings, "ISOSpeedRatings");
			ClassicAssert.AreEqual (1.0d / 180.0d, tag.ExposureTime);
			ClassicAssert.AreEqual (6.7d, tag.FNumber);
			ClassicAssert.AreEqual (50.0d, tag.FocalLength);
			ClassicAssert.AreEqual (new DateTime (2007, 01, 01, 12, 19, 34), tag.DateTime);
			ClassicAssert.AreEqual (new DateTime (2007, 01, 01, 13, 19, 34), tag.DateTimeDigitized);
			ClassicAssert.AreEqual (new DateTime (2007, 01, 01, 12, 19, 34), tag.DateTimeOriginal);
		}
		...
		{
			ClassicAssert.AreEqual (3008, file.Properties.PhotoWidth);
			ClassicAssert.AreEqual (2000, file.Properties.PhotoHeight);
