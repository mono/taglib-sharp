	...
	public class JpegBGO624097TestInvariantValidator : IMetadataInvariantValidator
	{
		public void ValidateMetadataInvariants (TagLib.Image.File file)
		{
			...
			// Image.0x0131 (Software/Ascii/21) "f-spot version 0.7.1"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("f-spot version 0.7.1", (entry as StringIFDEntry).Value);
			}
			// Image.0x0132 (DateTime/Ascii/20) "2010:07:01 22:19:26"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2010:07:01 22:19:26", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x829A (ExposureTime/Rational/1) "10/450"
			{
				...
				ClassicAssert.AreEqual (450, (entry as RationalIFDEntry).Value.Denominator);
			}
			// Photo.0x829D (FNumber/Rational/1) "33/10"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (33, (entry as RationalIFDEntry).Value.Numerator);
			...
			// Photo.0x9003 (DateTimeOriginal/Ascii/20) "2010:06:28 20:05:39"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("2010:06:28 20:05:39", (entry as StringIFDEntry).Value);
			}
			...
			// Photo.0x9205 (MaxApertureValue/Rational/1) "16/10"
			{
				...
				ClassicAssert.IsNotNull (entry as RationalIFDEntry, "Entry is not a rational!");
				ClassicAssert.AreEqual (16, (entry as RationalIFDEntry).Value.Numerator);
				ClassicAssert.AreEqual (10, (entry as RationalIFDEntry).Value.Denominator);
			}
			...
			// Nikon3.0x0002 (ISOSpeed/Short/2) "0 200"
			{
				...
				ClassicAssert.AreEqual (new ushort[] { 0, 200 }, (entry as ShortArrayIFDEntry).Values);
			}
			...
			// Nikon3.0x000C (WB_RBLevels/Rational/4) "522/256 290/256 256/256 256/256"
			{
				...
				ClassicAssert.AreEqual (522, parts[0].Numerator);
				ClassicAssert.AreEqual (256, parts[0].Denominator);
				ClassicAssert.AreEqual (290, parts[1].Numerator);
			...
			// Nikon3.0x0016 (ImageBoundary/Short/4) "0 0 4288 2848"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortArrayIFDEntry, "Entry is not a short array!");
				ClassicAssert.AreEqual (new ushort[] { 0, 0, 4288, 2848 }, (entry as ShortArrayIFDEntry).Values);
			}
			...
			// Nikon3.0x001D (SerialNumber/Ascii/8) "6004417"
			{
				...
				ClassicAssert.IsNotNull (entry as StringIFDEntry, "Entry is not a string!");
				ClassicAssert.AreEqual ("6004417", (entry as StringIFDEntry).Value);
			}
			...
			// Nikon3.0x0083 (LensType/Byte/1) "6"
			{
				...
				ClassicAssert.AreEqual (6, (entry as ByteIFDEntry).Value);
			}
			// Nikon3.0x0084 (Lens/Rational/4) "350/10 350/10 18/10 18/10"
			{
				...
				var parts = (entry as RationalArrayIFDEntry).Values;
				ClassicAssert.AreEqual (4, parts.Length);
				ClassicAssert.AreEqual (350, parts[0].Numerator);
				ClassicAssert.AreEqual (10, parts[0].Denominator);
				ClassicAssert.AreEqual (350, parts[1].Numerator);
				ClassicAssert.AreEqual (10, parts[1].Denominator);
				ClassicAssert.AreEqual (18, parts[2].Numerator);
				ClassicAssert.AreEqual (10, parts[2].Denominator);
				ClassicAssert.AreEqual (18, parts[3].Numerator);
			...
			// Nikon3.0x0097 (ColorBalance/Undefined/1302) "(Value ommitted)"
			{
				...
				ClassicAssert.AreEqual ("7c55759a885d8e977bc21e1a1a4bb011", parsed_hash);
			...
			// Nikon3.0x00A2 (ImageDataSize/Long/1) "4020390"
			{
				...
				ClassicAssert.AreEqual (4020390, (entry as LongIFDEntry).Value);
			}
			...
			// Nikon3.0x00A7 (ShutterCount/Long/1) "6292"
			{
				...
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (6292, (entry as LongIFDEntry).Value);
			}
			...
			// Photo.0xA003 (PixelYDimension/Short/1) "2848"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (2848, (entry as ShortIFDEntry).Value);
			}
			...
			// Photo.0xA405 (FocalLengthIn35mmFilm/Short/1) "52"
			{
				...
				ClassicAssert.IsNotNull (entry as ShortIFDEntry, "Entry is not a short!");
				ClassicAssert.AreEqual (52, (entry as ShortIFDEntry).Value);
			}
			...
			// Thumbnail.0x0202 (JPEGInterchangeFormatLength/Long/1) "9661"
			{
				...
				ClassicAssert.IsNotNull (entry as LongIFDEntry, "Entry is not a long!");
				ClassicAssert.AreEqual (9661, (entry as LongIFDEntry).Value);
			}
